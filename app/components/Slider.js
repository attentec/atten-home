...
let Slider = React.createClass({
  ...
  shouldComponentUpdate: function (nextProps, nextState) {
       ...
       this.state.containerSize.width !== nextState.containerSize.width;
   },
  ...
  render() {
    ...
    let {value, containerSize, trackSize, thumbSize} = this.state;
    const mainStyles = styles || defaultStyles;
    let thumbLeft = this._getThumbLeft(value);
